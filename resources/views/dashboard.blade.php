        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="100">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Ruswandi.png') }}" class="img-fluid" alt="">
            </div>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="200">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Iing S.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Iing S</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="200">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Uyun.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="300">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Uyat.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Uyat</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="300">
            <div class="member-img">
              <img src="{{ asset('/assets/img/dadang.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Dadang</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="300">
            <div class="member-img">
              <img src="{{ asset('/assets/img/aidah.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Aidah</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="300">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Nurhaedah.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Hj. Nurhaedah</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="300">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Yuda.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Muhammad Yuda</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="400">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Khoer.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Hoer Apandi</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="500">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Saeful.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Saepul Rahman</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="600">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Cecep.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="600">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Toto.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Toto Heryanto</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="600">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Sutisman.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Sutisman</h4>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="600">
            <div class="member-img">
              <img src="{{ asset('/assets/img/Neng Eli.png') }}" class="img-fluid" alt="">
            </div>
            <div class="member-info text-center">
              <h4>Neng Eli</h4>
